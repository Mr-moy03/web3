...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1>Chismes</h1>
        <a href="table_1/crear.php" class="btn btn-primary">Crear Nueva Chisme</a>
    </div>
    ...
    <table class="table table-striped">
        ...
        <?php while($fila = mysqli_fetch_array($resultado)): ?>
            <tr>
                ...
                <td>
                    <a href='table_1/modificar.php?id=<?php echo $fila['id']; ?>' class='btn btn-sm btn-success'>Modificar</a>
